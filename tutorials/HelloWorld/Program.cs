...
namespace HelloWorld
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string ns = "Assets";
            Console.WriteLine("hash=0x{0:x}", GetMD5Hash(ns));
        ...
        {
            uint crc = crc32("Test");
            Console.WriteLine("crc={0:x}", crc);

            Crc32 alg = new Crc32();
            
            byte[] hash = alg.ComputeHash(Encoding.Default.GetBytes("Test"));
            Console.WriteLine("crc={0}", ByteToString(hash));
        }
